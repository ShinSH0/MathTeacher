...
"background-position:center center; background-repeat: no-repeat;background-image: url(:/icon/photo-camera.png);")
...
"background-position:center center; background-repeat: no-repeat;background-image: url(:/icon/edit.png);")
...
"background-position:center center; background-repeat: no-repeat;background-image: url(:/icon/folder.png);")
...
"background-image: url(:/icon/keyboard.png); background-position:center center; background-repeat: no-repeat")
